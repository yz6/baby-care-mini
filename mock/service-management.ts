...
export const activityPlans: ActivityPlanItem[] = [
  { id: "plan-1", season: "春", monthRange: "13-18月", title: "春日触感篮", summary: "通过自然材料刺激触觉与语言表达。" },
  { id: "plan-2", season: "夏", monthRange: "19-24月", title: "水与容器探索", summary: "训练精细动作与专注力。" },
  { id: "plan-3", season: "秋", monthRange: "25-36月", title: "落叶分类赛", summary: "促进认知分类与合作行为。" },
];
